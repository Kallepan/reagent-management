...
describe('TypeAPIService', () => {
  ...
  it('should get all types', () => {
    const mockTypes: BakType[] = [
      { id: '1', name: 'test1', producer: 'test_producer_1',created_at: '2021-01-01T00:00:00.000Z' },
      { id: '2', name: 'test2', producer: 'test_producer_2',created_at: '2021-01-01T00:00:00.000Z' },
